...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <p><i class="fas fa-star"> <i class="fas fa-star"></i><i class="fas fa-star"></i></i> <i class="fas fa-star-half-alt"></i></p>
      <p>How Many People Have Rated: ${product.rating.count}</p>
